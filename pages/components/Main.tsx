        ...
        <div>
            <div className="bg-white">
                <div
                    ...
                    <div className="">
                        <Painting name={""} imageSrc={"/1.jpg"} href={"/pictures/1.jpg"}/>
                    ...
                    <div className="mt-10 px-4">
                        ...
                        <p className="text-justify mt-4 text-gray-700">
                            ...
                            시선과 성장기, 노년의 시선이 다르다. 나이가 들면 어린아이가
                            된다고한다. 단순해지기 때문이다. 노년의 단순함이란 물론 많은 것이
                            ...
                            더불어 빙그레 웃음을 머금기도 한다. 꽃의 매력이다. 내가 보인 이
