        ...
        <div className="max-w-2xl mx-auto py-10 px-4 grid items-center grid-cols-1 gap-y-4 gap-x-8 sm:px-6 lg:max-w-6xl lg:px-8 lg:grid-cols-2">
          ...
          <div className="mt-10 px-4">
            ...
            <p className="text-justify mt-4 text-gray-700">
              ...
              시작해서 넓게는 자신의 가치관이 나 철학도 여기 범 주로 생각한다.
              가끔은 시선의 각도를 조금 달리 시각으로 돌리면, 어떻게 볼 것인 가?
              무엇을 볼 것인가? 또 다른 무엇을 봐 야 하나?? 등 많은 카테고리를
              가진 말이라 생각된다. 또한 이 시선은 나이를 가린 다. 어린아이의
              시선과 성장기, 노년의 시선이 다르다. 나이가 들면 어린아이가 된다
              고한다. 단순해지기 때문이다. 노년의 단순함이란 물론 많은 것이
              내포된 단순함이라 할 수 있다. 어린아이처럼 순수 해질수는 없다.
              그렇지 만세상과도 조금 떨어져 서자연과 닮고 싶어 한다. 잠시 우리가
              시선이 머무는 곳이 어디인지 관심을 가지고 보면 동 물의 어린 새끼와
              어린아이 또는 새싹이나 꽃이다. 꽃은 그 모습자체만으로 시선이
